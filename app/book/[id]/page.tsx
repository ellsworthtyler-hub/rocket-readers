...
import ClientBookAction from './ClientBookAction';
...
export default async function BookStatsPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  // Full stats (restored from your original file)
  const stats = {
    totalSentences: 1240,
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-12">
      ...
      {/* Part of Speech Breakdown + Pie Chart Placeholder */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
        <div className="bg-white p-8 rounded-3xl border border-slate-100">
        ...
        <div className="bg-white p-8 rounded-3xl border border-slate-100 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-slate-500">Pie chart coming in next update</p>
          </div>
        </div>
      </div>
